<%@ Page Title="" Language="C#" MasterPageFile="~/editarp.master" AutoEventWireup="true" CodeFile="editarp.aspx.cs" Inherits="editarp" %>
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server">
                <asp:DropDownList ID="DropDownList4" runat="server">
                    ...
                    <asp:ListItem value ="3">Comun</asp:listitem>
