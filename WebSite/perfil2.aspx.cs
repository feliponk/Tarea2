...
public partial class perfil2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        this.Button1.Visible = false;
        String grup = (String)Session["grup"];
        String ids = (String)Session["ids"];
        String id_us = Request.QueryString["id"];
        if (String.Compare(ids, id_us) == 0 || String.Compare(grup,"0") == 0)
        {
        ...
        while (dr5.Read())
        {
            ...
            else
            {
                ...
                SqlCommand cm6 = new SqlCommand("select * from Tema where  id_tema =" + id_tem, cn4);
    ...
    {
        String id_us = Request.QueryString["id"];
        Session.Add("aux", id_us);
        Server.Transfer("editarp.aspx");
    }
}