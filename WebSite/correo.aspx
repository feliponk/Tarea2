<%@ Page Title="" Language="C#" MasterPageFile="~/correo.master" AutoEventWireup="true" CodeFile="correo.aspx.cs" Inherits="correo" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder4">
    <asp:Table ID="Table1" runat="server" Width="556px">
        ...
        <asp:TableRow runat="server">
            <asp:TableCell runat="server">
                <asp:TextBox ID="TextBox3" runat="server" cols="45" rows="8"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
        <asp:TableRow runat="server">
            <asp:TableCell runat="server">
