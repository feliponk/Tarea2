...
public partial class menu : System.Web.UI.Page
{
    ...
    {
        this.Label3.Text = "<div class='masthead cf'>" +
                    "CATEGORIAS" +
                "</div>";
        ...
        {
            contenido = "<span class='tags'><a href='eliminarc.aspx?id=" + id + "'  class='post-heading' >Eliminar</a></span>"+
                        "<span class='tags'><a href='agregarc.aspx  class='post-heading' >Agregar categoria</a></span>";
        }
        ...
        while (dr.Read())
        {
            ...
            aux = "<article class='format-standard'>" +
                     ...
                     "<div class='box cf'>" +
                         ...
                         "<div class='excerpt'>" +
                             "<a href='temas2.aspx?id=" + id + "'  class='post-heading' >" + name + "</a>" +
                             "<p>" + descripcion + "</p>" +
